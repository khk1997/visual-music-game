...
export const keyboardHelpToggle = document.getElementById('keyboard-help-toggle');
export const keyboardHelpPanel = document.getElementById('keyboard-help-panel');
export const keyboardHelpTitle = document.getElementById('keyboard-help-title');
export const keyboardHelpLayout = document.getElementById('keyboard-help-layout');
export const keyboardHelpSlots = document.getElementById('keyboard-help-slots');
